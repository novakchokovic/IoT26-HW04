...
1. [조립하기](#1-조립하기)
2. [OS 업데이트](#2-os-업데이트)
3. [가상환경 생성 및 Flask 설치](#3-가상환경-생성-및-flask-설치)
4. [app.py 만들기](#4-apppy-만들기)
5. [templates 폴더 및 HTML 파일 만들기](#5-templates-폴더-및-html-파일-만들기)
6. [서버 실행 및 브라우저 접속](#6-서버-실행-및-브라우저-접속)
7. [실행 결과](#7-실행-결과)
...
> 📹 시연 영상: `KakaoTalk_20260527_061336861.mp4`
